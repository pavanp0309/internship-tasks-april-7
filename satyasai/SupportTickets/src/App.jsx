...
const App = () => {
  const tickets = [
    ...
    },
    {
      ...
      customerType: "Free",
      issueSummary: "Feature request",
      issueDescription: "Requesting a dark mode feature for the dashboard.",
  ...
  return (
    ...
    <div className="container py-5">
      <div className="text-center mb-5">
        <h1 className="display-6 fw-bold text-primary">🛠️ Support Ticket Dashboard</h1>
